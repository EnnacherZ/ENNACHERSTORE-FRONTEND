...
const FilterSection: React.FC<FilterSectionProps> = ({handleFilter, productType}) =>{
    ...
    return(
        <>
        <div className={`filter-section ${dropOn?"extended":""} px-1 ${isPhone?'':'rounded'}`}>
            ...
            (<>
                ...
                <div className={`filter-dropped-inputs ${dropOn?"active":""}`}>
                    ...
                    <div className={`FDI-S2 ${dropOn?'active':''}`}>
                        ...
                        <div className={isPhone?'':"mb-3 "}>
                            <button type='reset' className="btn btn-secondary inputs-button"  onClick={handleReset}>Reset</button>
                        </div>
                    </div>
        ...
        <div className="filter-inputs">
                ...
                <div className={isPhone?'':"mb-3 "}>
                    ...
                    <span className="input-group-text"><AiFillProduct /></span>
                    <input
                        readOnly
                        disabled
                        className="form-control mt-1"
